...
function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/254739285768"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="WhatsApp Support"
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white rounded-full shadow-lg px-4 py-3 transition-all hover:scale-105 group"
    >
